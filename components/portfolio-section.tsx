        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#464545] mb-6">
              Veja como transformamos ideias em <span className="text-[#e2bfff]">resultados incríveis</span>{' '}
            </h2>
            <p className="text-lg md:text-xl text-[#464545]/80 max-w-2xl mx-auto">
              Cada projeto, uma identidade única e transformadora
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-4 auto-rows-min">
                  {project.items.map((item, itemIndex) => {
                    if (itemIndex === 0 && item.type === 'logo') {
                      return (
                        <motion.div
                          key={itemIndex}
                          className="h-[64vh] col-span-6 md:col-span-5 lg:col-span-6 row-span-2 bg-[#464545] rounded-2xl md:rounded-3xl border-4 border-[#464545] shadow-[6px_6px_0px_0px_#464545] hover:shadow-[3px_3px_0px_0px_#464545] hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-200 cursor-pointer group overflow-hidden"
                  ...
                  {/* Grid com os 4 cards à direita */}
                  <div className="col-span-6 md:col-span-3 lg:col-span-4 grid grid-cols-2 gap-4 h-[64vh]">
                    {project.items.slice(1, 5).map((item, itemIndex) => (
                      <motion.div
                        key={itemIndex}
                        className="bg-[#464545] rounded-2xl md:rounded-3xl border-4 border-[#464545] shadow-[6px_6px_0px_0px_#464545] hover:shadow-[3px_3px_0px_0px_#464545] hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-200 cursor-pointer flex items-center justify-center text-2xl md:text-3xl lg:text-4xl font-bold text-[#464545] text-center"
                        initial={{ opacity: 0, scale: 0.8 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                      ...
                      >
                        <div className="w-full h-full flex items-center justify-center text-4xl md:text-6xl lg:text-8xl font-black border-4 border-[#464545] rounded-2xl md:rounded-3xl bg-[#f5f3e7]">
                          <span className="text-[#464545]">{item.content}</span>
                        </div>
                      </motion.div>
                    ))}
                ...
                {/* Info Card */}
                {/* <div className="col-span-12 row-span-1 flex items-center justify-center mt-4">
                  <motion.div
                    className="h-16 md:h-24 lg:h-28 bg-[#f5f3e7] rounded-2xl md:rounded-3xl border-4 border-[#464545] shadow-[6px_6px_0px_0px_#464545] hover:shadow-[3px_3px_0px_0px_#464545] hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-200 cursor-pointer flex items-center justify-center w-[100%] md:w-[50%]"
                    initial={{ opacity: 0, scale: 0.8 }}
                    whileInView={{ opacity: 1, scale: 1 }}
          ...
          >
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="flex-1 relative bg-[#464545] flex items-center justify-center">
                ...
                <button
                  className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-[#e7eaa1] text-[#464545] p-3 rounded-full border-4 border-[#464545] shadow-[4px_4px_0px_0px_#464545] hover:shadow-[2px_2px_0px_0px_#464545] hover:translate-x-[2px] transition-all duration-150"
                  onClick={prevImage}
                >
                ...
                <button
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-[#e7eaa1] text-[#464545] p-3 rounded-full border-4 border-[#464545] shadow-[4px_4px_0px_0px_#464545] hover:shadow-[2px_2px_0px_0px_#464545] hover:translate-x-[2px] transition-all duration-150"
                  onClick={nextImage}
                >
